        ...
        <div class="row">
            <div class="col-lg-9 mx-auto">
                ...
                <ul class="list-inline">
                    <li class="list-inline-item"><a class="text-default" href="{{ route ('index')}}">Home
                            &nbsp; &nbsp; /</a></li>
                    <li class="list-inline-item text-primary">Tin Tức</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="post-slider">
              <img src="{{ asset('images/' . $allArticle->image) }}"  class="card-img-top w-75" alt="post-thumb">
            </div>
            <div class="card-body">
              <h3 class="mb-3"><a class="post-title" href="post-elements.html">{{ $allArticle->title }}.</a></h3>
              ...
              <p>{{ $allArticle->content }}.</p>
              <a href="{{ route('detail', $allArticle->id) }}" class="btn btn-outline-primary">Read More</a>
            </div>
          </article>
            @endforeach

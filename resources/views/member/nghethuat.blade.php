    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8  mb-5 mb-lg-0">
                <h1 class="h2 mb-4">BẢN TIN <mark>{{ $category->name }}</mark></h1>
                @foreach($articles as $article)
                    <article class="card mb-4">
                        <div class="post-slider">
                            <img src="{{ asset('images/' . $article->image) }}" alt="post-thumb">
                        </div>
                        <div class="card-body">
                            ...
                            <p>{{ $article->content }}.</p>
                            <a href="{{ route('detail', $article->id) }}" class="btn btn-outline-primary">Read More</a>
                        </div>
                    </article>
                @endforeach
            </div>
            ...
            <aside class="col-lg-4 sidebar-inner">
                ...
                <div class="widget widget-categories">
                    ...
                    <ul class="list-unstyled widget-list">
                        <li><a href="tags.html" class="d-flex">Thể thao </a></li>
                        <li><a href="tags.html" class="d-flex">Nghệ thuật </a></li>
                        <li><a href="tags.html" class="d-flex">Thời sự</a></li>
                    </ul>
                </div><!-- tags -->
                <div class="widget">

        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-5 col-md-6 mb-4 mb-md-0">
                <div class="image-wrapper">
                    <img class="img-fluid w-100" src="client/images/about-me.jpg">
                </div>
            </div>
...
<section class="section wave">
    <img src="client/images/backgrounds/wave-bg.svg" class="wave-bg">
    <div class="container">
        <div class="row justify-content-around align-items-center">
            ...
            <div class="col-lg-4 col-md-6">
                <img src="client/images/mission.png" class="img-fluid">
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-lg-5 col-md-6 mb-4 mb-md-0 order-1 order-md-2">
                <div class="video-wrapper">
                    <img src="client/images/youtube.png" class="img-fluid">
        ...
        <div class="row">
                ...
                <div class="card border-0 rounded-0 text-center shadow-none overflow-hidden">
                    <a href="#!">
                        <div class="book-cover">
                            <img src="client/images/books/01.jpg" alt="" class="card-img-top rounded-0">
                        </div>
                        <div class="card-body">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="card border-0 rounded-0 text-center shadow-none overflow-hidden">
                    <a href="#!">
                        <div class="book-cover">
                            <img src="client/images/books/02.jpg" alt="" class="card-img-top rounded-0">
                        </div>
                        <div class="card-body">
                            <h4 class="text-uppercase mb-3">Book of Earth</h4>
                            <p class="h4">$25.00</p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="card border-0 rounded-0 text-center shadow-none overflow-hidden">
                    <a href="#!">
                        <div class="book-cover">
                            <img src="client/images/books/03.jpg" alt="" class="card-img-top rounded-0">
                        </div>
                        <div class="card-body">
                            <h4 class="text-uppercase mb-3">Book of Earth</h4>
                            <p class="h4">$25.00</p>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="card border-0 rounded-0 text-center shadow-none overflow-hidden">
                    <a href="#!">
                        <div class="book-cover">
                            <img src="client/images/books/04.jpg" alt="" class="card-img-top rounded-0">
                        </div>
                        <div class="card-body">
                            <h4 class="text-uppercase mb-3">Book of Earth</h4>
                            <p class="h4">$25.00</p>
        ...
        <div class="row">
            <div class="col-lg-10 mx-auto text-center">
                ...
                <ul class="list-inline logo-list">
                    ...
                    <li class="list-inline-item"><img class="img-fluid" src="client/images/logos/logo-1.png"></li>

                    <li class="list-inline-item"><img class="img-fluid" src="client/images/logos/logo-2.png"></li>

                    <li class="list-inline-item"><img class="img-fluid" src="client/images/logos/logo-3.png"></li>

                    <li class="list-inline-item"><img class="img-fluid" src="client/images/logos/logo-4.png"></li>

                    <li class="list-inline-item"><img class="img-fluid" src="client/images/logos/logo-5.png"></li>

                    <li class="list-inline-item"><img class="img-fluid" src="client/images/logos/logo-6.png"></li>

                    <li class="list-inline-item"><img class="img-fluid" src="client/images/logos/logo-7.png"></li>

                    <li class="list-inline-item"><img class="img-fluid" src="client/images/logos/logo-8.png"></li>

                    <li class="list-inline-item"><img class="img-fluid" src="client/images/logos/logo-9.png"></li>
